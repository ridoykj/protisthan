...
function DashboardChartView() {
  ...
  useEffect(() => {
    DocFieldDtoCrudService.list(pagination, filterGenerator('and', 'parent', 'Dashboard Chart')).then((result) => {
      setUiField(result);
    });
  }, []);
    ...
    return (
      <button
        ...
        onClick={(e) => {
          setUser(item);
          read(item);
          navigate(`/m/dashboard-chart/${name}`);
        }}
      >
        {name}
      </button>
        ...
        <div className="flex flex-col h-full items-stretch ">
          ...
          <div className="h-full mx-2 mb-2 bg-white p-3 rounded-xl border">
            <AutoGrid
              ...
              visibleColumns={['name', 'chartName', 'idx']}

...
import SupplierDto from 'Frontend/generated/com/itbd/application/db/dto/supplier/SupplierDto';
import SupplierDtoModel from 'Frontend/generated/com/itbd/application/db/dto/supplier/SupplierDtoModel';
...
function SupplierView() {
  ...
  const {
    ...
    validate,
    addValidator,
  } = useForm(SupplierDtoModel, {
    onSubmit: async (userE) => {
      await SupplierDtoCrudService.save(userE)
        .then((result) => {
          clear();
  ...
  function ChildRedirect({ item }: { item: SupplierDto }) {

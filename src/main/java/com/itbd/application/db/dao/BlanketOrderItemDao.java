...
@Getter
@Setter
@Table(name = "t_blanket_order_item", indexes = {
        @Index(name = "idx_item_code", columnList = "tx_item_code"),
        @Index(name = "idx_parent", columnList = "tx_parent")
})
public class BlanketOrderItemDao {
    ...
    @Column(name = "tx_party_item_code", length = 140)
    private String partyItemCode;
    ...
    @Column(name = "tx_terms_and_conditions", columnDefinition = "text")

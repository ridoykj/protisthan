package com.itbd.application.db.dao.accounts.dunning;
...
@Getter
@Setter
@Table(name = "t_dunning_type", indexes = {
        @Index(name = "idx_modified", columnList = "dtt_modified")
}, uniqueConstraints = {
        @UniqueConstraint(name = "uk_dunning_type", columnNames = {"tx_dunning_type"})
})
public class DunningTypeDao {
    ...
    @Column(name = "tx_dunning_type", unique = true, length = 140)

...
@Getter
@Setter
@Table(name = "t_subcontracting_receipt_supplied_item", indexes = {
        @Index(name = "idx_parent", columnList = "tx_parent")
})
public class SubcontractingReceiptSuppliedItemDao {
    ...
    @Column(name = "flt_available_qty_for_consumption", nullable = false, precision = 21, scale = 9)
    @ColumnDefault("0.0")
    private BigDecimal availableQtyForConsumption;

...
@Getter
@Setter
@Table(name = "t_kanban_board", indexes = {
        @Index(name = "idx_modified", columnList = "dtt_modified")
}, uniqueConstraints = {
        @UniqueConstraint(name = "uk_kanban_board_name", columnNames = {"tx_kanban_board_name"})
})
public class KanbanBoardDao {
    ...
    @Column(name = "tx_kanban_board_name", unique = true, length = 140)
    ...
    @Column(name = "is_show_labels", nullable = false)
    @ColumnDefault("0")

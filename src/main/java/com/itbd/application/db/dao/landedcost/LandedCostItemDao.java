...
@Getter
@Setter
@Table(name = "t_landed_cost_item", indexes = {
        @Index(name = "idx_parent", columnList = "tx_parent")
})
public class LandedCostItemDao {
    ...
    @Column(name = "tx_itemCode", length = 140)
    private String itemCode;

    @Column(name = "tx_description", columnDefinition = "longtext")
    private String description;

    @Column(name = "tx_receipt_document_type", length = 140)
    private String receiptDocumentType;

    @Column(name = "tx_receipt_document", length = 140)
    ...
    @Column(name = "flt_applicable_charges", nullable = false, precision = 21, scale = 9)
    @ColumnDefault("0.0")

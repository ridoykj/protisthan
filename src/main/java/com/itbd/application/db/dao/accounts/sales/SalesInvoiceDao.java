...
@Getter
@Setter
@Table(name = "t_sales_invoice", indexes = {
...
public class SalesInvoiceDao {
    ...
    @Column(name = "tx_customer_name", columnDefinition = "text")
    ...
    @Column(name = "tx_company_tax_id", length = 140)
    ...
    @Column(name = "tx_set_target_warehouse", length = 140)
    private String setTargetWarehouse;
    ...
    @Column(name = "tx_apply_discount_on", length = 15)
    ...
    @Column(name = "is_cash_or_non_trade_discount", nullable = false)
    @ColumnDefault("0")
    private Boolean isCashOrNonTradeDiscount;

    @Column(name = "tx_additional_discount_account", length = 140)
    private String additionalDiscountAccount;
    ...
    @Column(name = "flt_total_billing_hours", nullable = false, precision = 21, scale = 9)
    @ColumnDefault("0.0")
    private BigDecimal totalBillingHours;
    ...
    @Column(name = "tx_poNo", length = 140)
    private String poNo;
    ...
    @Column(name = "tx_is_opening", length = 4)
    @ColumnDefault("'No'")
    ...
    @Column(name = "tx_language", length = 6)

...
@Getter
@Setter
@Table(name = "t_item_alternative", indexes = {
        @Index(name = "idx_modified", columnList = "dtt_modified")
})
public class ItemAlternativeDao {
    ...
    @Column(name = "tx_alternative_item_code", length = 140)
    ...
    @Column(name = "tx_alternative_item_name", length = 140)

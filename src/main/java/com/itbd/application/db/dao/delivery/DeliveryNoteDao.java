...
@Getter
@Setter
@Table(name = "t_delivery_note", indexes = {
...
public class DeliveryNoteDao {
    ...
    @Column(name = "is_issue_credit_note", nullable = false)
    @ColumnDefault("0")
    private Boolean issueCreditNote;
    ...
    @Column(name = "flt_per_installed", nullable = false, precision = 21, scale = 9)
    @ColumnDefault("0.0")
    private BigDecimal perInstalled;

    @Column(name = "tx_installation_status", length = 140)
    ...
    @Column(name = "tx_vehicle_no", length = 140)
    ...
    @Column(name = "tx_po_no", columnDefinition = "text")
    private String poNo;
    ...
    @Column(name = "is_print_without_amount", nullable = false)
    @ColumnDefault("0")
    private Boolean printWithoutAmount;
    ...
    @Column(name = "tx_excise_page", length = 140)
    private String excisePage;

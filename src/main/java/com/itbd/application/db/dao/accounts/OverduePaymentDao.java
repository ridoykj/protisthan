...
@Getter
@Setter
@Table(name = "t_overdue_payment", indexes = {
        @Index(name = "idx_parent", columnList = "tx_parent")
})
public class OverduePaymentDao {
    ...
    @Column(name = "tx_payment_schedule", length = 140)
    private String paymentSchedule;

    @Column(name = "ct_dunning_level", nullable = false)
    ...
    @Column(name = "tx_overdue_days", length = 140)
    ...
    @Column(name = "flt_interest", nullable = false, precision = 21, scale = 9)
    @ColumnDefault("0.0")

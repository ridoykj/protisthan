...
@Getter
@Setter
@Table(name = "t_installation_note_item", indexes = {
        @Index(name = "idx_prev_document_doc_name", columnList = "tx_prev_document_doc_name"),
        @Index(name = "idx_prev_document_doc_type", columnList = "tx_prev_document_doc_type"),
        @Index(name = "idx_parent", columnList = "tx_parent")
})
public class InstallationNoteItemDao {
    ...
    @Column(name = "tx_prev_document_detail_doc_name", length = 140)
    private String prevDocumentDetailDocName;

...
@Getter
@Setter
@Table(name = "t_email_unsubscribe", indexes = {
        @Index(name = "idx_email", columnList = "tx_email"),
        @Index(name = "idx_modified", columnList = "dtt_modified")
})

public class EmailUnsubscribeDao {
    ...
    @Column(name = "is_global_unsubscribe", nullable = false)
    @ColumnDefault("0")

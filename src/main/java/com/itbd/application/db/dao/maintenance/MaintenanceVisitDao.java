...
@Getter
@Setter
@Table(name = "t_maintenance_visit", indexes = {
        @Index(name = "idx_modified", columnList = "dtt_modified")
})
public class MaintenanceVisitDao {
    ...
    @Column(name = "tx_maintenance_schedule", length = 140)
    private String maintenanceSchedule;

    @Column(name = "tx_maintenance_schedule_detail", length = 140)
    private String maintenanceScheduleDetail;

    @Column(name = "dt_mntcDate")
    private LocalDate mntcDate;

    @Column(name = "tt_mntc_time")
    private LocalTime mntcTime;

    @Column(name = "tx_completion_status", length = 140)
    private String completionStatus;

    @Column(name = "tx_maintenance_type", length = 140)
    @ColumnDefault("'Unscheduled'")
    private String maintenanceType;

    @Column(name = "tx_customer_feedback", columnDefinition = "text")

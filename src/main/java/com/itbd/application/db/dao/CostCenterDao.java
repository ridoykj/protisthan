...
@Getter
@Setter
@Table(name = "t_cost_center", indexes = {
...
public class CostCenterDao {
    ...
    @Column(name = "tx_cost_center_name", length = 140)
    private String costCenterName;

    @Column(name = "tx_cost_center_number", length = 140)
    private String costCenterNumber;

    @Column(name = "tx_parent_cost_center", length = 140)
    private String parentCostCenter;
